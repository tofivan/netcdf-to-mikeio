...
for filename in os.listdir(input_folder):
    if filename.endswith(".nc"):  
        ...
        elb_values = pom_ds["elb"].values[:,:,:]  # 新增的"elb"參數
        ...
        for i, time in enumerate(all_time_values):
            ...
            salinity = s_values[i,:,:]
            elevation = elb_values[i,:,:]  # 新增的"elb"參數
            ...
            data_elb.append(elevation)  # 新增的elb數據
        ...
        data_elb = np.array(data_elb)  # 新增的elb數據
        ...
        das = [
            ...
            mikeio.DataArray(data_elb, time=all_time_values, geometry=g,  
        ...
        # 針對每個輸入文件只輸出一個dfs2文件
        output_filename = f"{output_folder}/{os.path.splitext(filename)[0]}_pom_alltime.dfs2"
